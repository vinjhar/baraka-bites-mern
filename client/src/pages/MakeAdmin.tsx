...
import { Search, Shield, ShieldOff, Loader2, AlertCircle, Crown, ChefHat } from 'lucide-react';
...
interface User {
  ...
  isPremium: boolean;
  createdAt: string;
  recipes?: string[]; // Add recipes array to the interface
}
...
const MakeAdmin: React.FC = () => {
  ...
  // Calculate total recipes generated by all users
